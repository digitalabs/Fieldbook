...
public class StandardVariableRESTController {
	...
	static {
		...
		StandardVariableRESTController.PLOT_DATA_VARIABLE_FILTER.addVariableType(VariableType.NURSERY_CONDITION);
		StandardVariableRESTController.PLOT_DATA_VARIABLE_FILTER.addVariableType(VariableType.TRIAL_CONDITION);
