...
public class GermplasmTreeController extends AbstractBaseFieldbookController {
	...
	protected Integer saveGermplasmList(SaveListForm form, Map<Germplasm, GermplasmListData> listDataItems) throws MiddlewareQueryException {
	...
	private GermplasmList createGermplasmList(SaveListForm saveListForm, Integer currentUserId) {
		...
		return new GermplasmList(null, listName, dateLong, listType, currentUserId, description, parent, status,
