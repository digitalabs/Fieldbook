		...
		for (final MeasurementData data : row.getDataList()) {
			if (data.isCategorical()) {
				...
				dataMap.put(data.getMeasurementVariable().getName(), new Object[] {categoricalDisplayValue.getName() + suffix,
						categoricalDisplayValue.getDescription() + suffix, data.isAccepted(), data.getMeasurementDataId() != null ? data.getMeasurementDataId() : "", (data.getValueStatus() != null) ? data.getValueStatus().toString() : null });

			} else if (data.isNumeric()) {
				dataMap.put(data.getMeasurementVariable().getName(), new Object[] {data.getDisplayValue() + suffix, data.isAccepted(), data.getMeasurementDataId() != null ? data.getMeasurementDataId() : "", (data.getValueStatus() != null) ? data.getValueStatus().toString() : null });
			} else {
				dataMap.put(data.getMeasurementVariable().getName(), new Object[] {data.getDisplayValue() != null ? data.getDisplayValue() : "",
						data.getMeasurementDataId() != null ? data.getMeasurementDataId() : "", (data.getValueStatus() != null) ? data.getValueStatus().toString() : null });
			}
		}
