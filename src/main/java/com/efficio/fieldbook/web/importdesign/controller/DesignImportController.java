...
public class DesignImportController extends SettingsController {
	...
	public Map<String, Object> getCustomImportDesignTypeDetails() {
		...
		if(this.userSelection.getExpDesignParams() != null && this.userSelection.getExpDesignParams().getFileName() != null && !this.userSelection.getExpDesignParams().getFileName().isEmpty()){
			...
			return output;
		} else if(this.userSelection.getDesignImportData() != null && this.userSelection.getDesignImportData().getImportFileName() != null && !this.userSelection.getDesignImportData().getImportFileName().isEmpty()){
