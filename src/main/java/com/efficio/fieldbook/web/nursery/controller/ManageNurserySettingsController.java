...
public class ManageNurserySettingsController extends SettingsController{
    ...
    public String saveSettings(@ModelAttribute("manageSettingsForm") ManageSettingsForm form
    	...
    	Dataset dataset = (Dataset)SettingsUtil.convertPojoToXmlDataset(fieldbookMiddlewareService, form.getSettingName(), form.getStudyLevelVariables(), form.getPlotLevelVariables(), form.getBaselineTraitVariables(), userSelection, null);
    ...
    private List<SettingDetail> getSettingDetailList(int mode) {
    	if (mode == AppConstants.SEGMENT_STUDY.getInt()) {
            ...
            return userSelection.getNurseryConditions();
        }
    	return null;
    }
