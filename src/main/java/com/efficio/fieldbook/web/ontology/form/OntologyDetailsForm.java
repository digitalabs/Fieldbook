...
public class OntologyDetailsForm {
	...
	public void setVariable(StandardVariable variable) {
		...
		if (variable != null) {
			...
			this.setCropOntologyId(variable.getCropOntologyId());
			this.setConstraints(variable.getConstraints());
			this.setCategoricalValues(variable.getEnumerations());
		}
	}

	public String getPossiblePairsJson() {
		return this.possiblePairsJson;
	}
