...
public enum AppConstants {
	...
	, EXPORT_NURSERY_FIELDLOG_FIELDROID, EXPORT_NURSERY_R, EXPORT_NURSERY_EXCEL, EXPORT_DATAKAPTURE, EXPORT_KSU_EXCEL, EXPORT_KSU_CSV, EXPORT_CSV

	, LIST_DATE, LIST_TYPE

	, FILE_NOT_EXCEL_ERROR, FILE_NOT_CSV_ERROR, FILE_NOT_FOUND_ERROR

	, EXPORT_FIELDLOG_SUFFIX, EXPORT_R_SUFFIX, EXPORT_XLS_SUFFIX, DATAKAPTURE_TRAITS_SUFFIX, EXPORT_CSV_SUFFIX, EXPORT_KSU_TRAITS_SUFFIX
