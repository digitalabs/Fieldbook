...
public enum AppConstants {
	...
	, AVAILABLE_LABEL_FIELDS_ENTRY_NUM, AVAILABLE_LABEL_FIELDS_GID, AVAILABLE_LABEL_FIELDS_GERMPLASM_NAME, AVAILABLE_LABEL_FIELDS_YEAR, AVAILABLE_LABEL_FIELDS_SEASON, AVAILABLE_LABEL_FIELDS_STUDY_NAME, AVAILABLE_LABEL_FIELDS_TRIAL_INSTANCE_NUM, AVAILABLE_LABEL_FIELDS_REP, AVAILABLE_LABEL_FIELDS_LOCATION, AVAILABLE_LABEL_FIELDS_BLOCK_NAME, AVAILABLE_LABEL_FIELDS_PLOT, AVAILABLE_LABEL_FIELDS_PARENTAGE, AVAILABLE_LABEL_FIELDS_PLOT_COORDINATES, AVAILABLE_LABEL_FIELDS_FIELD_NAME, AVAILABLE_LABEL_BARCODE, FIELDMAP_LABEL_FIELDS, AVAILABLE_LABEL_SEED_INVENTORY_AMOUNT, AVAILABLE_LABEL_SEED_INVENTORY_SCALE, AVAILABLE_LABEL_SEED_LOT_ID, AVAILABLE_LABEL_SEED_SOURCE, AVAILABLE_LABEL_FIELDS_DESIGNATION, AVAILABLE_LABEL_FIELDS_CROSS, AVAILABLE_LABEL_FIELDS_STOCK_ID, AVAILABLE_LABEL_FIELDS_LIST_NAME
	...
	, ENTRIES_LABEL, HAS_MEASUREMENTS_LABEL, HAS_FIELDMAP_LABEL, HIDDEN_FIELDS, SPFLD_ENTRIES, SPFLD_COUNT_VARIATES, SPFLD_HAS_FIELDMAP, SPFLD_PLOT_COUNT, SELECTION_VARIATES_PROPERTIES, FIXED_STUDY_VARIABLES
	...
	, MAXIMUM_NUMBER_OF_SUB_OBSERVATION_SETS, MAXIMUM_NUMBER_FOR_EACH_PARENT_UNIT;
