...
public enum AppConstants {
    ...
    , AVAILABLE_LABEL_FIELDS_FIELD_NAME
    , AVAILABLE_LABEL_BARCODE
    , FIELDMAP_LABEL_FIELDS
    , AVAILABLE_LABEL_SEED_INVENTORY_AMOUNT
    , AVAILABLE_LABEL_SEED_INVENTORY_SCALE
    , AVAILABLE_LABEL_SEED_LOT_ID
    ...
    ,HIDE_TRIAL_VARIABLE_SETTINGS_FIELDS
    ,HIDE_PLOT_FIELDS
    ,HIDE_GERMPLASM_DESCRIPTOR_HEADER_TABLE
    ...
    ,CHECK_VARIABLES
    ,NURSERY_BASIC_DETAIL_FIELDS_HIDDEN_LABELS
