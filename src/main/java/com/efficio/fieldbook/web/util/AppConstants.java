...
public enum AppConstants {
	...
	, SEGMENT_STUDY, SEGMENT_PLOT, SEGMENT_TRAITS, SEGMENT_TRIAL_ENVIRONMENT, SEGMENT_TREATMENT_FACTORS, SEGMENT_SELECTION_VARIATES, SEGMENT_NURSERY_CONDITIONS, SEGMENT_GERMPLASM
	...
	, EXPORT_NURSERY_FIELDLOG_FIELDROID, EXPORT_NURSERY_R, EXPORT_NURSERY_EXCEL, EXPORT_DATAKAPTURE, EXPORT_KSU_EXCEL, EXPORT_KSU_CSV, EXPORT_CSV, IMPORT_NURSERY_FIELDLOG_FIELDROID, IMPORT_NURSERY_EXCEL, IMPORT_DATAKAPTURE, IMPORT_KSU_EXCEL, IMPORT_KSU_CSV
	...
	, CREATE_NURSERY_REQUIRED_FIELDS, CREATE_PLOT_REQUIRED_FIELDS, HIDE_NURSERY_FIELDS, HIDE_TRIAL_FIELDS, HIDE_TRIAL_VARIABLE_DBCV_FIELDS, HIDE_TRIAL_VARIABLE_SETTINGS_FIELDS, HIDE_PLOT_FIELDS, HIDE_GERMPLASM_DESCRIPTOR_HEADER_TABLE, FILTER_NURSERY_FIELDS, ID_NAME_COMBINATION, ID_CODE_NAME_COMBINATION_STUDY, ID_CODE_NAME_COMBINATION_VARIATE, HIDE_ID_VARIABLES, REMOVE_FACTORS_IN_USE_PREVIOUS_STUDY, CREATE_TRIAL_REQUIRED_FIELDS, HIDE_TRIAL_MANAGEMENT_SETTINGS_FIELDS, CREATE_TRIAL_ENVIRONMENT_REQUIRED_FIELDS, CREATE_TRIAL_PLOT_REQUIRED_FIELDS, CREATE_TRIAL_DEFAULT_PLOT_FIELDS, CREATE_TRIAL_EXP_DESIGN_DEFAULT_FIELDS, CREATE_TRIAL_REMOVE_TREATMENT_FACTOR_IDS, HIDE_TRIAL_ENVIRONMENT_FIELDS, HIDE_TRIAL_ENVIRONMENT_FIELDS_FROM_POPUP, DEFAULT_NO_OF_ENVIRONMENT_COUNT, CHECK_VARIABLES, NURSERY_BASIC_DETAIL_FIELDS_HIDDEN_LABELS
