...
public class CrossesListUtil {
	...
	public Map<String, Object> generateCrossesTableWithDuplicationNotes(final List<String> tableHeaderList,
		...
		dataMap.put(ColumnLabels.DUPLICATE.getName(), "");
		dataMap.put(tableHeaderList.get(CrossesListUtil.FEMALE_PEDIGREE), crossesData.getFemaleParent().getPedigree());
		dataMap.put(ColumnLabels.FEMALE_PARENT.getName().toUpperCase(), crossesData.getFemaleParentDesignation());
		...
		dataMap.put(ColumnLabels.MALE_PARENT.getName().toUpperCase(), maleDesignations);
		...
		dataMap.put(ColumnLabels.FGID.getName(), crossesData.getFemaleGid());
		dataMap.put(ColumnLabels.MGID.getName(), this.getGids(crossesData.getMaleParents()));
		return dataMap;
	}
	...
	public Map<String, Object> generateCrossesTableWithDuplicationNotes(final List<String> tableHeaderList, final ImportedCrosses importedCrosses) {
		...
		dataMap.put(ColumnLabels.DUPLICATE.getName(), importedCrosses.getDuplicate());
		dataMap.put(tableHeaderList.get(CrossesListUtil.FEMALE_PEDIGREE), importedCrosses.getFemalePedigree());
		dataMap.put(ColumnLabels.FEMALE_PARENT.getName().toUpperCase(), importedCrosses.getFemaleCross());
		...
		dataMap.put(ColumnLabels.MALE_PARENT.getName().toUpperCase(), importedCrosses.getMaleCross());
		...
		dataMap.put(ColumnLabels.FGID.getName(), importedCrosses.getFemaleGid());
		dataMap.put(ColumnLabels.MGID.getName(), importedCrosses.getMaleGids());
