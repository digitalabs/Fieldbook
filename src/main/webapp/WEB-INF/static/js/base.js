...
function createErrorNotification( titleDisplay, textDisplay){
	var $container = createNotification('default-error-notification',titleDisplay,textDisplay);
}
...
function createNotification( template, titleDisplay, textDisplay){
	...
	return $container.notify('create', template, {title: titleDisplay, text: textDisplay}, {expires: false, click: function(e,instance){
		instance.close();
	}});
}