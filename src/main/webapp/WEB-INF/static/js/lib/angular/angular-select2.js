    ...
    return {
        ...
        compile: function (tElm, tAttrs) {
            ...
            return function (scope, elm, attrs, controller) {
                ...
                if (tAttrs.valueAsObject) {
                    if (tAttrs.valueAsObject === 'false')
                        opts.idAsValue = true;
                        ...
                        elm.bind("change", function (e) {
                            ...
                            scope.$apply(function () {
                                ...
                                controller.$setViewValue(
                                    !opts.idAsValue ? convertToAngularModel(elm.select2('data')) : convertToAngularModel(elm.select2('val')));
                            });
                        });
