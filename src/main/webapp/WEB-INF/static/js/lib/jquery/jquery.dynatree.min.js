...
//      this.logDebug("dynatree.redraw() done.");
	...
	reload: function(callback) {
		//added by daniel for reloading
		if(typeof treeReloading == 'undefined')			
			this._load(callback);
		else if(treeReloading == 0 || treeReloading == null)
			this._load(callback);
	},
	reloadStudyTree: function(callback) {
		//added by daniel for reloading
		this._load(callback);
...
//              logMsg("    draggable.offset.click FIXED: %s/%s", draggable.offset.click.left, draggable.offset.click.top);
		...
		drag: function(event, ui) {
			...
			t.css("cursor", 'move');
			*/
			//added for the fixed of the draggable
			...
			//$(draggable).css('top', event.clientX);
			//$(draggable).css('left', event.clientY);
			//console.log($(draggable).css('top') + " : " + event.clientX + " " + $(draggable).css('left') + " : "+ event.clientY);
