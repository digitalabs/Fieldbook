...
public class ExportFieldmapServiceImplTest extends AbstractBaseIntegrationTest {
	 ...
	 * @return the list
	 */
	private List<FieldMapLabel> generateTestFieldMapLabels(final int range, final int col) {
		final List<FieldMapLabel> labels = new ArrayList<FieldMapLabel>();
		for (int i = 0; i < range * col; i++) {
			final FieldMapLabel label = new FieldMapLabel(null, null, "DummyData-" + i, i, i);
			label.setStudyName("Dummy Study");
			labels.add(label);
		}
		return labels;
	}
	...
	public void testExportFieldMapToExcelHorizontalSerpentine() throws Exception {
		...
		final UserFieldmap userFieldMap = this.createUserFieldMap();
		final Map<String, String> deletedPlot = this.createDeletedPlot();

		final List<FieldMapLabel> fieldMapLabels =
		...
		final String fileName = "FieldMapHorizontal" + "_" + DateUtil.getCurrentDateAsStringValue() + ".xls";
		this.exportFieldmapService.exportFieldMapToExcel(fileName, userFieldMap);

		Assert.assertEquals("Dummy Study-76<br/>Entry null<br/>Rep 76", plots[2][9].getDisplayString());
		Assert.assertEquals("Dummy Study-70<br/>Entry null<br/>Rep 70", plots[8][9].getDisplayString());
	...
	public void testExportFieldMapToExcelVerticalSerpentine() throws Exception {
		...
		final String fileName = "FieldMapVertical" + "_" + DateUtil.getCurrentDateAsStringValue() + ".xls";
		this.exportFieldmapService.exportFieldMapToExcel(fileName, userFieldMap);

		Assert.assertEquals("Dummy Study-10<br/>Entry null<br/>Rep 10", plots[2][9].getDisplayString());
		Assert.assertEquals("Dummy Study-67<br/>Entry null<br/>Rep 67", plots[8][9].getDisplayString());
		Assert.assertTrue(plots[8][5].isPlotDeleted());
	}
	...
	public void testExportFieldMapToExcelHorizontalRowColumn() throws Exception {
		...
		final String fileName = "FieldMapHorizontalRowColumn" + "_" + DateUtil.getCurrentDateAsStringValue() + ".xls";
		this.exportFieldmapService.exportFieldMapToExcel(fileName, userFieldMap);
		Assert.assertEquals("Dummy Study-77<br/>Entry null<br/>Rep 77", plots[2][9].getDisplayString());
		Assert.assertEquals("Dummy Study-83<br/>Entry null<br/>Rep 83", plots[8][9].getDisplayString());
		Assert.assertTrue(plots[8][5].isPlotDeleted());
	}
	...
	public void testExportFieldMapToExcelVerticalRowColumn() throws Exception {
		...
		final String fileName = "FieldMapVerticalRowColumn" + "_" + DateUtil.getCurrentDateAsStringValue() + ".xls";
		this.exportFieldmapService.exportFieldMapToExcel(fileName, userFieldMap);
		Assert.assertEquals("Dummy Study-17<br/>Entry null<br/>Rep 17", plots[2][9].getDisplayString());
		Assert.assertEquals("Dummy Study-74<br/>Entry null<br/>Rep 74", plots[8][9].getDisplayString());
		Assert.assertTrue(plots[8][5].isPlotDeleted());
	}
	...
	private Map<String, String> createDeletedPlot() {
		final Map<String, String> deletedPlot = new HashMap<String, String>();
