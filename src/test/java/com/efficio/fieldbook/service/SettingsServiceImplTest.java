...
public class SettingsServiceImplTest {
	...
	public void testIsGermplasmListField_ReturnsTrueForExistingVariableInNursery() throws MiddlewareQueryException {
		Mockito.doReturn(this.createStandardVariableTestData(
				VariableType.GERMPLASM_DESCRIPTOR)).when(this.fieldbookMiddlewareService).
			getStandardVariable(Mockito.anyInt(), Mockito.anyString());
	...
	public void testIsGermplasmListField_ReturnsFalseForNonExistingVariableInNursery() throws MiddlewareQueryException {
		Mockito.doReturn(this.createStandardVariableTestData(VariableType.NURSERY_CONDITION)).
			when(this.fieldbookMiddlewareService).getStandardVariable(Mockito.anyInt(), Mockito.anyString());
	...
	public void testRetrieveTraitsAsLabels() throws Exception {
		...
		Mockito.doReturn(this.createStandardVariableTestData(VariableType.GERMPLASM_DESCRIPTOR)).
			when(this.fieldbookMiddlewareService).getStandardVariable(Mockito.anyInt(), Mockito.anyString());
	...
	public void testRetrieveGermplasmDescriptorsAsLabels() {
		...
		final List<LabelFields> labelFields = serviceDUT.retrieveGermplasmDescriptorsAsLabels(this.workbook);
