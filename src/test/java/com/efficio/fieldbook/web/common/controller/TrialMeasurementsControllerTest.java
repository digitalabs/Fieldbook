...
public class TrialMeasurementsControllerTest {
	...
	public void testGetPlotMeasurementsPaginated() {
		...
		// Method to test
		final Map<String, Object> plotMeasurementsPaginated = this.trialMeasurementsController
				.getPlotMeasurementsPaginated(1, 1, new CreateNurseryForm(), Mockito.mock(Model.class), request);
