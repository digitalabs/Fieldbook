...
public class DesignImportControllerTest {
	...
	public void testResolveIDNamePairingAndValuesForStudy() {
		...
		this.designImportController.resolveIDNamePairingAndValuesForTrial(environmentData, designImportData, measurementVariables);
	...
	public void testGenerateMeasurements() {
		...
		final EnvironmentData environmentData = this.createEnvironmentData(1);
		final GenerateDesignInput input = new GenerateDesignInput(environmentData, DesignType.CUSTOM_IMPORT, null, null, false);
