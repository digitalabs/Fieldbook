...
public class LabelPrintingControllerTest extends AbstractBaseControllerIntegrationTest {
    ...
    public void testGenerationOfPDFLabels() {
		...
		Map<String,Object> results = labelPrintingController.generateLabels(trialInstances, false);
	...
	public void testGetLabelPrintingCustomReportsIfThereIsStudyId() throws MiddlewareQueryException{
		...
		preset.setConfiguration("<reports><report><code>WLBL05</code><name>labels without design, wheat</name></report><report><code>WLBL21</code><name>labels with design, wheat</name></report></reports>");
